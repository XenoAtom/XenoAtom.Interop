...
This library does not provide C native binaries but only P/Invoke .NET bindings to `libdrm` `2.4.134-r0`.
...
> 
> - libdrm C include headers: [`libdrm-dev`](https://pkgs.alpinelinux.org/package/v3.24/main/x86_64/libdrm-dev)
> - Version: `2.4.134-r0`

...
This library does not provide C native binaries but only P/Invoke .NET bindings to `libgbm` `26.1.1-r1`.
...
> 
> - libgbm C include headers: [`mesa-dev`](https://pkgs.alpinelinux.org/package/v3.24/main/x86_64/mesa-dev)
> - Version: `26.1.1-r1`

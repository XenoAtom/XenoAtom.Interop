...
static unsafe partial class libgit2
{
    ...
    /// with the `git_message_prettify()` function.
    /// </remarks>
    public static libgit2.git_result git_commit_create(out libgit2.git_oid id, libgit2.git_repository repo, [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string update_ref,
        in libgit2.git_signature author, in libgit2.git_signature committer, [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string message_encoding,
        [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string message, libgit2.git_tree tree, ReadOnlySpan<libgit2.git_commit> parents)
    {
        fixed (libgit2.git_commit* parentsPtr = parents)
        {
            return git_commit_create(out id, repo, update_ref, author, committer, message_encoding, message, tree, parents.Length, parentsPtr);
    ...
    public static libgit2.git_result git_commit_create_buffer(out libgit2.git_buf @out, libgit2.git_repository repo, in libgit2.git_signature author, in libgit2.git_signature committer,
        [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string message_encoding,
        [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string message, libgit2.git_tree tree, ReadOnlySpan<libgit2.git_commit> parents)
    {
        fixed (libgit2.git_commit* parentsPtr = parents)
        {

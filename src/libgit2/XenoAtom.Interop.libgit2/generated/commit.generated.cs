...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_commit_lookup_prefix(out libgit2.git_commit commit, libgit2.git_repository repo, in libgit2.git_oid id, libgit2.size_t len);
        ...
        [global::System.Runtime.InteropServices.LibraryImport(LibraryName, EntryPoint = "git_commit_header_field")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_commit_header_field(out libgit2.git_buf @out, libgit2.git_commit commit, [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string field);
        ...
        [global::System.Runtime.InteropServices.LibraryImport(LibraryName, EntryPoint = "git_commit_extract_signature")]
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial int git_commit_extract_signature(ref libgit2.git_buf signature, libgit2.git_buf* signed_data, libgit2.git_repository repo, in libgit2.git_oid commit_id, [global::System.Runtime.InteropServices.Marshalling.MarshalUsing(typeof(UTF8MarshallerRelaxedNoCleanup))] string field);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_commit_create(out libgit2.git_oid id, libgit2.git_repository repo, byte* update_ref, in libgit2.git_signature author, in libgit2.git_signature committer, byte* message_encoding, byte* message, libgit2.git_tree tree, libgit2.size_t parent_count, libgit2.git_commit* parents);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_commit_create_v(out libgit2.git_oid id, libgit2.git_repository repo, byte* update_ref, in libgit2.git_signature author, in libgit2.git_signature committer, byte* message_encoding, byte* message, libgit2.git_tree tree, libgit2.size_t parent_count);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_commit_create_buffer(out libgit2.git_buf @out, libgit2.git_repository repo, in libgit2.git_signature author, in libgit2.git_signature committer, byte* message_encoding, byte* message, libgit2.git_tree tree, libgit2.size_t parent_count, libgit2.git_commit* parents);

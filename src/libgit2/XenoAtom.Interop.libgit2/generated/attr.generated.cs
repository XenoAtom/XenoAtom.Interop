...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_attr_get_many(ref byte* values_out, libgit2.git_repository repo, uint flags, byte* path, libgit2.size_t num_attr, ref byte* names);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_attr_get_many_ext(ref byte* values_out, libgit2.git_repository repo, ref libgit2.git_attr_options opts, byte* path, libgit2.size_t num_attr, ref byte* names);

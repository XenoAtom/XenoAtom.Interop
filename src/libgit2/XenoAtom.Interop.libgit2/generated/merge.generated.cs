...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        public enum git_merge_flag_t : int
        {
            ...
            /// </summary>
            GIT_MERGE_FIND_RENAMES = unchecked((int)(1  << (int) 0)),
            ...
            /// </summary>
            GIT_MERGE_FAIL_ON_CONFLICT = unchecked((int)(1  << (int) 1)),
            
            /// <summary>
            /// Do not write the REUC extension on the generated index
            /// </summary>
            GIT_MERGE_SKIP_REUC = unchecked((int)(1  << (int) 2)),
            ...
            /// </summary>
            GIT_MERGE_NO_RECURSIVE = unchecked((int)(1  << (int) 3)),
            ...
            /// </summary>
            GIT_MERGE_VIRTUAL_BASE = unchecked((int)(1  << (int) 4)),
        }
        ...
        public enum git_merge_file_favor_t : int
        {
            ...
            /// This is the default.
            /// </summary>
            GIT_MERGE_FILE_FAVOR_NORMAL = unchecked((int)0),
            ...
            /// </summary>
            GIT_MERGE_FILE_FAVOR_OURS = unchecked((int)1),
            ...
            /// region.  The index will not record a conflict.
            /// </summary>
            GIT_MERGE_FILE_FAVOR_THEIRS = unchecked((int)2),
            ...
            /// record a conflict.
            /// </summary>
            GIT_MERGE_FILE_FAVOR_UNION = unchecked((int)3),
        }
        ...
        public enum git_merge_file_flag_t : int
        {
            ...
            /// Defaults
            /// </summary>
            GIT_MERGE_FILE_DEFAULT = unchecked((int)0),
            
            /// <summary>
            /// Create standard conflicted merge files
            /// </summary>
            GIT_MERGE_FILE_STYLE_MERGE = unchecked((int)(1  << (int) 0)),
            
            /// <summary>
            /// Create diff3-style files
            /// </summary>
            GIT_MERGE_FILE_STYLE_DIFF3 = unchecked((int)(1  << (int) 1)),
            
            /// <summary>
            /// Condense non-alphanumeric regions for simplified diff file
            /// </summary>
            GIT_MERGE_FILE_SIMPLIFY_ALNUM = unchecked((int)(1  << (int) 2)),
            
            /// <summary>
            /// Ignore all whitespace
            /// </summary>
            GIT_MERGE_FILE_IGNORE_WHITESPACE = unchecked((int)(1  << (int) 3)),
            
            /// <summary>
            /// Ignore changes in amount of whitespace
            /// </summary>
            GIT_MERGE_FILE_IGNORE_WHITESPACE_CHANGE = unchecked((int)(1  << (int) 4)),
            
            /// <summary>
            /// Ignore whitespace at end of line
            /// </summary>
            GIT_MERGE_FILE_IGNORE_WHITESPACE_EOL = unchecked((int)(1  << (int) 5)),
            
            /// <summary>
            /// Use the "patience diff" algorithm
            /// </summary>
            GIT_MERGE_FILE_DIFF_PATIENCE = unchecked((int)(1  << (int) 6)),
            
            /// <summary>
            /// Take extra time to find minimal diff
            /// </summary>
            GIT_MERGE_FILE_DIFF_MINIMAL = unchecked((int)(1  << (int) 7)),
            
            /// <summary>
            /// Create zdiff3 ("zealous diff3")-style files
            /// </summary>
            GIT_MERGE_FILE_STYLE_ZDIFF3 = unchecked((int)(1  << (int) 8)),
            ...
            /// </summary>
            GIT_MERGE_FILE_ACCEPT_CONFLICTS = unchecked((int)(1  << (int) 9)),
        }
        ...
        public enum git_merge_analysis_t : int
        {
            ...
            /// </summary>
            GIT_MERGE_ANALYSIS_NONE = unchecked((int)0),
            
            /// <summary>
            /// A "normal" merge; both HEAD and the given merge input have diverged
            /// from their common ancestor.  The divergent commits must be merged.
            /// </summary>
            GIT_MERGE_ANALYSIS_NORMAL = unchecked((int)(1  << (int) 0)),
            
            /// <summary>
            /// All given merge inputs are reachable from HEAD, meaning the
            /// repository is up-to-date and no merge needs to be performed.
            /// </summary>
            GIT_MERGE_ANALYSIS_UP_TO_DATE = unchecked((int)(1  << (int) 1)),
            ...
            /// given merge input.
            /// </summary>
            GIT_MERGE_ANALYSIS_FASTFORWARD = unchecked((int)(1  << (int) 2)),
            ...
            /// </summary>
            GIT_MERGE_ANALYSIS_UNBORN = unchecked((int)(1  << (int) 3)),
        }
        ...
        public enum git_merge_preference_t : int
        {
            ...
            /// merge.
            /// </summary>
            GIT_MERGE_PREFERENCE_NONE = unchecked((int)0),
            
            /// <summary>
            /// There is a `merge.ff=false` configuration setting, suggesting that
            /// the user does not want to allow a fast-forward merge.
            /// </summary>
            GIT_MERGE_PREFERENCE_NO_FASTFORWARD = unchecked((int)(1  << (int) 0)),
            
            /// <summary>
            /// There is a `merge.ff=only` configuration setting, suggesting that
            /// the user only wants fast-forward merges.
            /// </summary>
            GIT_MERGE_PREFERENCE_FASTFORWARD_ONLY = unchecked((int)(1  << (int) 1)),
        }
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_merge_base_many(out libgit2.git_oid @out, libgit2.git_repository repo, libgit2.size_t length, libgit2.git_oid* input_array);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_merge_bases_many(out libgit2.git_oidarray @out, libgit2.git_repository repo, libgit2.size_t length, libgit2.git_oid* input_array);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_merge_base_octopus(out libgit2.git_oid @out, libgit2.git_repository repo, libgit2.size_t length, libgit2.git_oid* input_array);

...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_tree_lookup_prefix(out libgit2.git_tree @out, libgit2.git_repository repo, in libgit2.git_oid id, libgit2.size_t len);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.size_t git_tree_entrycount(libgit2.git_tree tree);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_tree_entry git_tree_entry_byindex(libgit2.git_tree tree, libgit2.size_t idx);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.size_t git_treebuilder_entrycount(libgit2.git_treebuilder bld);

...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        public static partial libgit2.git_result git_graph_ahead_behind(out nuint ahead, out nuint behind, libgit2.git_repository repo, in libgit2.git_oid local, in libgit2.git_oid upstream);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_graph_reachable_from_any(libgit2.git_repository repo, in libgit2.git_oid commit, libgit2.git_oid* descendant_array, nuint length);
    }
}

...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_blob_lookup_prefix(out libgit2.git_blob blob, libgit2.git_repository repo, in libgit2.git_oid id, nuint len);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial int git_blob_data_is_binary(byte* data, nuint len);

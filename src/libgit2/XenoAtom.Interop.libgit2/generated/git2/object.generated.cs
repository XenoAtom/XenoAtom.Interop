...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_object_lookup_prefix(out libgit2.git_object object_out, libgit2.git_repository repo, in libgit2.git_oid id, nuint len, libgit2.git_object_t type);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_object_rawcontent_is_valid(out int valid, byte* buf, nuint len, libgit2.git_object_t object_type);
    }
}

...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        /// </summary>
        /// <param name="path">is the path to the file</param>
        /// <param name="status_flags">the `git_status_t` values for file's status</param>
        /// <param name="payload">the user-specified payload to the foreach function</param>
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial nuint git_status_list_entrycount(libgit2.git_status_list statuslist);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_status_entry* git_status_byindex(libgit2.git_status_list statuslist, nuint idx);

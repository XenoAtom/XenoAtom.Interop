...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial byte* git_oid_tostr(byte* @out, nuint n, in libgit2.git_oid id);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_oid_shorten git_oid_shorten_new(nuint min_length);

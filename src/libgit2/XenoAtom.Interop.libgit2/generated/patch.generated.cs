...
namespace XenoAtom.Interop
{
    ...
    public static unsafe partial class libgit2
    {
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_patch_from_diff(out libgit2.git_patch @out, libgit2.git_diff diff, libgit2.size_t idx);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_patch_from_blob_and_buffer(out libgit2.git_patch @out, libgit2.git_blob old_blob, byte* old_as_path, void* buffer, libgit2.size_t buffer_len, byte* buffer_as_path, in libgit2.git_diff_options opts);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_patch_from_buffers(out libgit2.git_patch @out, void* old_buffer, libgit2.size_t old_len, byte* old_as_path, void* new_buffer, libgit2.size_t new_len, byte* new_as_path, in libgit2.git_diff_options opts);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.size_t git_patch_num_hunks(libgit2.git_patch patch);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.git_result git_patch_get_line_in_hunk(out libgit2.git_diff_line* @out, libgit2.git_patch patch, libgit2.size_t hunk_idx, libgit2.size_t line_of_hunk);
        ...
        [UnmanagedCallConv(CallConvs = new Type[] { typeof(CallConvCdecl) })]
        public static partial libgit2.size_t git_patch_size(libgit2.git_patch patch, int include_context, int include_hunk_headers, int include_file_headers);
